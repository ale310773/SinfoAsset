    ...
    Private Sub Ok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Ok.Click
        ...
        Try
            ...
            Else
                ...
                CircularProgressLoading.Visible = True
                CircularProgressLoading.IsRunning = True
...
Lagi:
    ...
    Private Sub PasswordTextBox_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles PasswordTextBox.KeyPress
        ...
        End If
    End Sub
    Private Sub FormLoginNew_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        CircularProgressLoading.ProgressText = "Silahkan Tunggu"
        CircularProgressLoading.ProgressTextVisible = True
        CircularProgressLoading.Value += 10

        ' CircularProgressLoading.Text = "Silahkan Tunggu"


        If CircularProgressLoading.Value >= CircularProgressLoading.Maximum Then
            ProgressRun.Execute()
        End If
        ...
        If CircularProgressLoading.Value >= CircularProgressLoading.Maximum Then
            ' ProgressRun.Execute()
            CircularProgressLoading.Value = 0
            CircularProgressLoading.Visible = False
            Timer1.Stop()
            Me.Hide()
            Form1.Show()
            Form1.BringToFront()
    ...
    Private Sub ProgressRun_Executed(ByVal sender As Object, ByVal e As EventArgs) Handles ProgressRun.Executed
        ...
        If running AndAlso CircularProgressLoading.Value >= CircularProgressLoading.Maximum Then
            CircularProgressLoading.Value = 0
        End If
